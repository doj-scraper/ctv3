...
/**
 * Core user table backing auth flow with Clerk integration.
...
/**
 * Cart items table for temporary shopping cart (session-based)
 */
...
/**
 * Order items table for line items in an order
 */
